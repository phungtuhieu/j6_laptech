...
CREATE TABLE Online_Payments (
	transaction_id NVARCHAR(15) NOT NULL,
	...
	bank_tran_no NVARCHAR(300) ,
	txn_ref NVARCHAR(105)  NOT NULL,
	secure_hash_type NVARCHAR(15) ,
	secure_hash NVARCHAR(300) NOT NULL,
...
ADD CONSTRAINT PK_Online_Payment PRIMARY KEY (transaction_id);
GO
...
ALTER TABLE Online_Payments
ADD CONSTRAINT FK_Online_Payments
FOREIGN KEY (order_id) REFERENCES Orders(id) ON UPDATE CASCADE ON DELETE NO ACTION ;
GO
-- /Order_Details
...
VALUES
    (25000000, 1000, '2023-07-10 07:00:00', '2023-09-11 08:00:00'),
    (18000000, 1001, '2023-07-11 07:00:00', '2023-09-11 08:00:00'),
    (30000000, 1002, '2023-07-12 07:00:00', '2023-09-12 08:00:00'),
    (8000000,  1003, '2023-07-13 07:00:00', '2023-09-13 08:00:00'),
    (12000000, 1004, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (35000000, 1005, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (42000000, 1006, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (54000000, 1007, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (23000000, 1008, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (41000000, 1009, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (23000000, 1010, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (25000000, 1011, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (41000000, 1012, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (31000000, 1013, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (35000000, 1014, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (23000000, 1015, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (18000000, 1016, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (38000000, 1017, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (41000000, 1018, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (38000000, 1019, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (25000000, 1020, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (28000000, 1021, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (29000000, 1022, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (23000000, 1023, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (32000000, 1024, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (31000000, 1025, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (43000000, 1026, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (35000000, 1027, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (36000000, 1028, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (38000000, 1029, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (32000000, 1030, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (13000000, 1031, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (12000000, 1032, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (32000000, 1033, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (53000000, 1034, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (17000000, 1035, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (34000000, 1036, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (23000000, 1037, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (52000000, 1038, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (32000000, 1039, '2023-07-14 07:00:00', '2023-09-14 08:00:00'),
    (30000000, 1040, '2023-07-14 07:00:00', '2023-09-14 08:00:00');
...
INSERT INTO Orders (user_id, order_date, completion_date, delivery_date, cancellation_date, cancellation_reason, payment_method,payment_status, [status])
VALUES
    (N'ngocanh01', '2023-07-21 10:00:00', '2023-07-21 15:30:00', '2023-07-24 09:00:00', '2023-07-22 11:00:00', N'Hủy đơn hàng do không có hàng', 1,0, 1),
    (N'thanhnam87', '2023-07-22 13:30:00', '2023-07-22 17:45:00', '2023-07-25 11:30:00', NULL, NULL, 1,1, 2),
    (N'minhchau02', '2023-07-23 09:15:00', '2023-07-23 16:00:00', '2023-07-26 08:45:00', NULL, NULL, 0,1, 1),
    (N'trungkien11', '2023-07-24 14:00:00', NULL, NULL, NULL, NULL, 1,1, 3),
    (N'trungkien11', '2023-07-24 14:00:00', NULL, NULL, NULL, NULL, 1,0, 3),
    (N'thuytrang9x', '2023-07-25 11:45:00', NULL, NULL, NULL, NULL, 0,1, 1)
GO
SELECT * FROM Orders
...
VALUES
    ('minhchau02', 1000, '2021-03-21'),
    ('minhchau02', 1002, '2021-02-21'),
    ('minhchau02', 1003, '2021-04-21'),
    ('minhchau02', 1006, '2021-05-21'),
    ('minhchau02', 1004, '2021-06-21'),
    ('minhchau02', 1002, '2021-03-21'),
    ('minhchau02', 1001, '2021-01-21'),
    ('minhchau02', 1009, '2021-04-21'),
    ('minhchau02', 1011, '2021-05-21'),
    ('minhchau02', 1012, '2021-06-21'),
    ('minhchau02', 1013, '2021-06-21'),
    ('minhchau02', 1021, '2021-07-21'),
    ('minhchau02', 1014, '2021-10-21'),
    ('minhchau02', 1032, '2021-09-21'),
    ('minhchau02', 1037, '2021-12-21'),

    ('ngocanh01', 1013, '2022-07-21'),
    ('ngocanh01', 1024, '2022-07-21'),
    ('ngocanh01', 1012, '2022-03-21'),
    ('ngocanh01', 1023, '2022-03-21'),
    ('ngocanh01', 1014, '2022-05-21'),
    ('ngocanh01', 1024, '2022-05-21'),
    ('ngocanh01', 1015, '2022-05-21'),
    ('ngocanh01', 1025, '2022-02-21'),
    ('ngocanh01', 1016, '2022-03-21'),
    ('ngocanh01', 1026, '2022-03-21'),
    ('ngocanh01', 1028, '2022-02-21'),
    ('ngocanh01', 1014, '2022-02-21'),
    ('ngocanh01', 1031, '2022-08-21'),
    ('ngocanh01', 1032, '2022-09-21'),
    ('ngocanh01', 1036, '2022-09-21'),

    ('thanhnam87', 1001, '2023-07-21'),
    ('thanhnam87', 1002, '2023-07-21'),
    ('thanhnam87', 1003, '2023-07-21'),
    ('thanhnam87', 1004, '2023-03-21'),
    ('thanhnam87', 1006, '2023-04-21'),
    ('thanhnam87', 1007, '2023-04-21'),
    ('thanhnam87', 1008, '2023-04-21'),
    ('thanhnam87', 1009, '2023-05-21'),
    ('thanhnam87', 1010, '2023-06-21'),
    ('thanhnam87', 1011, '2023-04-21'),

    ('thuytrang9x', 1004, '2023-05-21'),
    ('thuytrang9x', 1032, '2023-02-21'),
    ('thuytrang9x', 1034, '2023-07-21'),
    ('thuytrang9x', 1037, '2023-05-21'),
    ('thuytrang9x', 1026, '2023-10-21'),
    ('thuytrang9x', 1018, '2023-12-21'),
    ('thuytrang9x', 1020, '2023-02-21'),
    ('thuytrang9x', 1021, '2023-02-21'),
    ('thuytrang9x', 1022, '2023-03-21'),
    ('thuytrang9x', 1023, '2023-01-21'),
    ('thuytrang9x', 1024, '2023-01-21'),
    ('thuytrang9x', 1025, '2023-01-21'),
    ('thuytrang9x', 1031, '2023-03-21'),
    ('thuytrang9x', 1032, '2023-06-21'),
    ('thuytrang9x', 1033, '2023-07-21'),
    ('thuytrang9x', 1034, '2023-06-21'),
    ('thuytrang9x', 1035, '2023-09-21'),
    ('thuytrang9x', 1036, '2023-09-21'),

    ('trungkien11', 1027, '2023-08-21'),
    ('trungkien11', 1017, '2023-08-21'),
    ('trungkien11', 1025, '2023-08-21'),
    ('trungkien11', 1032, '2023-08-21'),
    ('trungkien11', 1032, '2023-08-21'),
    ('trungkien11', 1021, '2023-12-21'),
    ('trungkien11', 1023, '2023-11-21'),
    ('trungkien11', 1018, '2023-11-21'),
    ('trungkien11', 1034, '2023-10-21'),
    ('trungkien11', 1032, '2023-06-21'),
    ('trungkien11', 1031, '2023-09-21'),
    ('trungkien11', 1033, '2023-06-21'),
    ('trungkien11', 1035, '2023-06-21'),
    ('trungkien11', 1037, '2023-09-21'),
    ('trungkien11', 1039, '2023-10-21');
